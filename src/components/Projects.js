            ...
            <div id='main-projects'>
                ...
                <div className='project-card'>
                    ...
                    <div className='image2'>
                        <a href='https://cbc-weather-app.herokuapp.com/' target='_blank'><img id='weather' src="./images/weather.jpeg" /></a>
                    </div>
                    <p className='project-descr'>
                ...
                <div className='project-card'>
                    ...
                    <div className='image3'>
                        <a href='https://betrayal-at-baldurs-gate-react.herokuapp.com/' target='_blank'><img id='baldur' src="./images/baldur.jpeg" /></a>
                    </div>
                    <p className='project-descr'>
